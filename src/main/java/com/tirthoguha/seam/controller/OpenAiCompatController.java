...
import com.tirthoguha.seam.dto.openai.OpenAiChatCompletionChunk;
import com.tirthoguha.seam.dto.openai.OpenAiChatCompletionRequest;
import com.tirthoguha.seam.dto.openai.OpenAiChatCompletionResponse;
...
import com.tirthoguha.seam.provider.SamplingParams;
import com.tirthoguha.seam.provider.ToolCall;
import com.tirthoguha.seam.provider.ToolChoice;
import com.tirthoguha.seam.provider.ToolSpec;
import com.tirthoguha.seam.service.ChatService;
import com.tirthoguha.seam.service.EmbeddingService;

/**
 * OpenAI-compatible gateway. Exposes {@code GET /v1/models} and {@code POST /v1/chat/completions} so
 * any OpenAI-API client (e.g. Open WebUI) can drive Seam as if it were OpenAI — while requests
